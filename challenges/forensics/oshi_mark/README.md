...
raw notes:
  ...
  - there's more to this than meets the eye. select the text and copy it, and you get back a _lot_ of code points
  - dump into <https://www.fontspace.com/unicode/analyzer>. we can see the shooting star and ribbon emojis bookend a bunch of variation selectors and zero width non-joiners
  - we're interested in just the variation selectors. get their numbers, interpret as ASCII, and you get:
    ```
    ...
    ```
  - meta: this was a clever one. what clued me in was copying what appeared to be two emojis into DDG and seeing: (i) the request fail; and (ii) the `q` query parameter massively expand
